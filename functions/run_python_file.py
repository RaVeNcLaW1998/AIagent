...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs a file with the python3 interpreter and return the output as a string , Accepts additional CLI args as an optional array.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                description="The optional array of strings to be used as the CLI args for the python file.",
